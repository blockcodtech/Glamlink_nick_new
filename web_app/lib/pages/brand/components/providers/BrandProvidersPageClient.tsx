...
interface BrandProvidersPageClientProps {
  brandId: string;
}

export default function BrandProvidersPageClient({ brandId }: BrandProvidersPageClientProps) {
  ...
  const { header_state, providers_state } = getComponentStates(state);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <CertifiedProviders 
          props={{ 
            ...
            handlers: {
              onProviderClick: handlers.onProviderClick
            }
          }} 
        />
      </div>
