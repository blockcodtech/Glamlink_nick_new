...
interface BrandGalleryPageClientProps {
  brandId: string;
}

export default function BrandGalleryPageClient({ brandId }: BrandGalleryPageClientProps) {
  ...
  const { header_state, gallery_state } = getComponentStates(state);
